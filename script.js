...
var HTMLquestions=[
    ...
    {
        question: "Can the accuracy and completeness of personal information be secured even if illegal personal information changes or damages occur due to external hacking, misuse of insider authority, etc.?",
        choices: ["YES","NO","not responsible","do not know"],
        answer: 1
    
    },
    
    {
        question: "What is wrong with the example of privacy restrictions? ",
        choices: ["More than the first letter of the name in the name.","the date of birth","Internet Address","Address"],
        answer: 4
